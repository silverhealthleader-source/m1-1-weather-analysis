...
> ⚠ **작성자 확인 필요** — 인사이트 1~4의 *해석(Why)* 은 후보 2개를 제시했습니다. 하나를 고르거나 직접 수정한 뒤, 이 안내 문구를 지우고 제출하세요.
...
- 🔲 **[확인 필요]** 기상청 기후평년값(1991~2020)과의 월별 비교는 수행하지 않았다. 평년값 대비 위치를 확인하면 계절별 해석을 보완할 수 있다.
...
| 시계열 분해 추세성분 (6장) | +0.30℃ |
| 연평균 단순선형회귀 | **+1.18℃** (p=0.026) |

앞의 두 값은 **시작·끝 두 시점을 비교한 값**이고, 회귀는 10개 점 전체의 기울기다.
2016년(13.58℃)이 상대적으로 따뜻한 해였고 2024년(14.69℃)이 10년 중 최고치였던 탓에, 어느 쪽을 쓰느냐에 따라 3배 차이가 난다.

**② 구간을 조금만 바꿔도 기울기가 요동친다**

| 구간 | 기울기 | p값 | 유의성 |
|---|---|---|---|
| 2016~2022 | **+0.11℃/10년** | 0.830 | 무의미 |
| 2016~2023 | +0.60℃/10년 | 0.249 | 무의미 |
| 2016~2024 | +1.28℃/10년 | 0.048 | 유의 |
| 2016~2025 | +1.18℃/10년 | 0.026 | 유의 |
| 2020~2025 | **+2.20℃/10년** | 0.088 | 무의미 |

시작·끝 연도를 한두 해 옮기는 것만으로 **+0.11 ~ +2.20℃/10년**, 약 20배 범위에서 흔들린다.
...
| **본 분석 (2016~2025)** | **동일 6** | **14.46℃** | **+1.24℃/10년** |
| 본 분석 (2016~2025) | 98 | 13.59℃ | +1.22℃/10년 |
...
| **기간 민감도·통제 비교 계산** | "10년은 짧다"는 한계를 문장이 아니라 수치로 증명 | **시작·끝 연도를 바꿔가며 기울기를 6회 재계산해 +0.11~+2.20℃ 범위를 확인. 기상청 113년 보고서와 같은 6개 지점만 골라 재계산해, 차이의 원인이 지점 구성이 아니라 기간 길이임을 분리 검증함** |
