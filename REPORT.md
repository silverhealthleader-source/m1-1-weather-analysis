...
| **기후동행카드** (서울) | 월 정액 대중교통 무제한 — 승용차 이용을 대중교통으로 전환 | [서울시 정책 아카이브](https://www.seoul.go.kr/policy/view.do?id=1016) |
...
> **⚠ 확인 필요** — 기후동행카드의 온실가스 감축 효과가 보도된 바 있으나, 본 리포트 작성 시점에 **원자료를 직접 확인하지 못해 수치는 싣지 않았다.**
